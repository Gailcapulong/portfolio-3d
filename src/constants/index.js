...
export const servicesData = [
  {
    ...
    description:
      "Your business deserves fast, secure, and future-proof digital foundation. I develop custom web apps with clean architecture, optimized databases, and seamless integrations—ensuring reliability at every layer.",
    items: [
      {
...
export const projects = [
  {
    ...
    description:
      "A multi-categorized online shop featuring electronics, home appliances, and gaming peripherals with special offers..",
  ...
  },
  {
    ...
    description:
      "a project designed to streamline employees administration by managing employee records, attendance, leave requests, and other essential workforce information through a centralized and user-friendly platform..",
  ...
  },
  {
    ...
    description:
      "A multi-category featuring electronics, home appliances, and gaming gears.",
  ...
  },
  {
    ...
    name: "Luma Studio",
    description:
      "an AI-powered Saas image redesign platform that transforms photos into stunning artistic styles with just one upload. Create high-quality, gallery-ready images quickly and effortlessly.",
