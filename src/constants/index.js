...
export const projects = [
  ...
  },
  {
    ...
    name: "Luma Studio",
    description:
      "an AI-powered Saas image redesign platform that transforms photo into stunning artistic styles with just one upload. Create high-quality, gallery-ready images quickly and effortlessly.",
