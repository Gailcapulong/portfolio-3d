...
export const servicesData = [
  {
    ...
    description:
      "Your business deserves fast, secure, reliable, and future-proof digital foundation. I develop custom web apps with clean architecture, optimized databases, and seamless integrations—ensuring reliability at every layer.",
    items: [
      {
  ...
  },
  {
    title: "Web Apps",
    description:
      "A interface that sink even the best ideas. Craft responsively, pixel perfect web and mobile apps (React Native/Flutter) that users love—bridging design and functionality seamlessly.",
    items: [
      {
...
export const projects = [
  {
    ...
    description:
      "A multi-categorized online shopping featuring electronics, home appliance, and gaming peripherals with special offers..",
  ...
  },
  {
    ...
    name: "iMessage ",
    description:
      "A responsive web-base message application that enables real-time communication through a clean and user-friendly interface.",
  ...
  },
  {
    ...
    description:
      "Project to streamline employees administration by manage employee records, attendance, leave requests, and other essential workforce information through a centralized and user-friendly platform..",
  ...
  },
  {
    ...
    name: "The Movie App",
    description:
      "A curate collection of designer home decor items, including furnitures and vases.",
...
export const socials = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/c.gail.09?igsh=MTFmeDFrOHo0cHV4",
  },
  {
    name: "Facebook",
    href: "https://www.facebook.com/gail.capulong/",
  },
  { name: "LinkedIn", href: "" },
  { name: "GitHub", href: "https://github.com/Gailcapulong" },
];
